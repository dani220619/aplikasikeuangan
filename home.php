...
include 'control/tanggal-indo.php';
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>KOMPLEK L</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  <a href="logout.php" class="btn btn-default btn-flat">Profil</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li><a href="?page=beranda"><i class="fa fa-home"></i> <span>Beranda</span></a></li> 
       <li><a href="?page=data-santri"><i class="fa fa-home"></i> <span>Data Santri</span></a></li> 
        <li><a href="?page=pembayaran"><i class="fa fa-home"></i> <span>Pembayaran</span></a></li>
      ...
      <li><a href="?page=administrator"><i class="fa fa-users"></i> <span>Data Administrator</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
