...
class mypdf extends FPDF{
    ...
    function header(){
        ...
        $this->cell(276,5,'PANTI ASUHAN MURNI',0,0,'C');
        $this->Ln();
        $this->setfont('Arial','B',12);
        $this->cell(276,10,'JL SINGA NO 81 MAKASSAR',0,0,'C');
        $this->Ln(5);
        $this->setfont('Arial','B',12);
...
@$no++;
        ...
        // mencetak tanggal
        $this->Ln(4);
        $this->Cell(276,15,' MAKASSAR, '.$tanggalini,0,1, 'R');
      
        $this->Cell(262,1,'BENDAHARA',0,1, 'R');  
        $this->Ln(5);
       
            $this->Cell(272,30,'MINO O CH TUMIMOMOR',0,1,'R');
        }
