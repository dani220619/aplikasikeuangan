            ...
            <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th width="50%" bgcolor=#71DCFF><center>Uraian</center></th>
                ...
                <tbody>
                     <?php
                    $no = 0;
                    $modal = mysqli_query($conn,"SELECT * FROM kas where jenis= 'pengeluaran'");
                  ...
                  <?php } ?> 
                   ...
                   <tr>
                    ...
                    <?php
                      $totmasuk = mysqli_query($conn,"SELECT SUM(kredit) AS total,tgl FROM kas ");
